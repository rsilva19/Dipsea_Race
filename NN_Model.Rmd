...
# fit neural network
set.seed(21)
NN = neuralnet(Actual_Time ~ Age + Section_NN + Sex_NN , trainNN, hidden = 3 , linear.output = T, stepmax = 1e7 )
...
# fit neural network
set.seed(21)
NN = neuralnet(Actual_Time ~ Age + Sex_NN , trainNN, hidden = 2 , linear.output = T, stepmax = 1e7 )
...
# Calculate Root Mean Square Error (RMSE)
RMSE.NN = (sum((x - predict_testNN)^2) / nrow(x)) ^ 0.5
```
